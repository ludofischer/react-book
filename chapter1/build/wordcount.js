...
/***/ function(module, exports, __webpack_require__) {
	...
	var Editor = React.createClass({displayName: 'Editor',
	    ...
	    render: function() {
	        ...
	        return (React.createElement("div", {className: "form-group"}, 
	                ...
	                React.createElement(ProgressBar, {percentComplete: percentComplete})
	                )
	        );
	    }
	});
	...
	React.renderComponent(
	    React.createElement(Editor, {targetWordCount: 10}),
	   ...
	   render: function() {
	     ...
	     return  (
	       React.createElement("div", {className: "progress"}, 
	        React.createElement("div", {className: progressClass, role: "progressbar", 'aria-valuenow': "this.props.percentComplete", 'aria-valuemin': "0", 'aria-valuemax': "100", style: {width: this.props.percentComplete + '%'}}, 
	          React.createElement("span", {className: "sr-only"}, this.props.percentComplete, "% Complete")
	        )
	      ) 
	     );
	   }
