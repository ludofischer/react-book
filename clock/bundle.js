...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(Clock, null), document.getElementById('test'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Analog = __webpack_require__(3);
	var DigitalClock = __webpack_require__(4);
	...
	var Clock = (function (_React$Component) {
	    function Clock() {
	        ...
	        _get(Object.getPrototypeOf(Clock.prototype), 'constructor', this).call(this);
	    ...
	    _createClass(Clock, [{
	        ...
	        value: function render() {
	            return React.createElement('div', null, React.createElement(Analog, { major: range(12), minor: range(12), date: this.state.date }), React.createElement(DigitalClock, { date: this.state.date }));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClockFace = (function () {
	    ...
	    _createClass(ClockFace, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement('div', { className: 'clock' }, React.createElement('div', { className: 'square' }, React.createElement('svg', { viewBox: '0 0 100 100' }, React.createElement('g', { transform: 'translate(50,50)' }, React.createElement('circle', { className: 'clock-face', r: '48' }), this.props.minor.map(function (i) {
	                var key = 'minor-' + i;
	                return React.createElement('line', { key: key, className: 'minor', y1: '42', y2: '45', transform: 'rotate(' + 360 * i / minorLength + ')' });
	            }), this.props.major.map(function (i) {
	                var key = 'major-' + i;
	                return React.createElement('line', { key: key, className: 'major', y1: '35', y2: '45', transform: 'rotate(' + 360 * i / majorLength + ')' });
	            }), React.createElement('line', { className: 'hour', y1: '2', y2: '-20', transform: 'rotate(' + (30 * date.getHours() + date.getMinutes() / 2) + ')' }), React.createElement('line', { className: 'minute', y1: '4', y2: '-30', transform: 'rotate(' + (6 * date.getMinutes() + date.getSeconds() / 10) + ')' }), React.createElement('g', { transform: 'rotate(' + 6 * date.getSeconds() + ')' }, React.createElement('line', { className: 'second', y1: '10', y2: '-38' }), React.createElement('line', { className: 'second-counterweight', y1: '10', y2: '2' }))))));
	        }
	    }]);
	...
	/* first create a group and move it to 50,50 so                                     all co-ords are relative to the center */ /* markers every minute (major markers every 5 minutes) */ /* hour hand */ /* minute hand */ /* second hand */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DigitalClock = (function () {
	    ...
	    _createClass(DigitalClock, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return React.createElement('div', { className: 'left' }, React.createElement('p', null, 'Today is ', this.dateFormat.format(this.props.date), '. The time is:'), React.createElement('span', { className: 'time' }, this.timeFormat.format(this.props.date)));
	        }
	    }]);
