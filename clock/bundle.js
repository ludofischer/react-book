...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(Clock, null), document.getElementById('example'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var Analog = __webpack_require__(4);
	var DigitalClock = __webpack_require__(5);
	...
	var Clock = React.createClass({displayName: "Clock",
	  ...
	  render: function() {
	    return (React.createElement("div", null, 
	      React.createElement(Analog, {major: range(12), minor: range(12), date: this.state.date}), 
	      React.createElement(DigitalClock, {date: this.state.date})
	    ));
	  }
	});
	                ...
	                React.createElement("div", {className: "square"}, 
	                    React.createElement("svg", {viewBox: "0 0 100 100"}, 
	                        ...
	                        React.createElement("g", {transform: "translate(50,50)"}, 
	                            React.createElement("circle", {className: "clock-face", r: "48"}), 
	                            ...
	                            /* markers every minute (major markers every 5 minutes) */
	                             ...
	                             this.props.minor.map(function (i) {
	                                 var key = 'minor-' + i;
	                                 return (
	                                     React.createElement("line", {key: key, className: "minor", y1: "42", y2: "45", transform: 'rotate(' + (360 * i / minorLength) + ')'})
	                                 );
	                             }), 
	                                      ...
	                                      this.props.major.map(function(i) {
	                                          var key = 'major-' + i;
	                                          return (
	                                              React.createElement("line", {key: key, className: "major", y1: "35", y2: "45", transform: 'rotate(' +  (360 * i / majorLength) + ')'})
	                                          )
	                                      }), 
	                                      

	                                              /* hour hand */
	                                              React.createElement("line", {className: "hour", y1: "2", y2: "-20", transform: 'rotate(' +
	                                                    (30 * date.getHours() + date.getMinutes() / 2) + ')'}), 

	                                              /* minute hand */
	                                              React.createElement("line", {className: "minute", y1: "4", y2: "-30", transform: 'rotate(' +
	                                                    (6 * date.getMinutes() + date.getSeconds() / 10) + ')'}), 

	                                              /* second hand */
	                                              React.createElement("g", {transform: 'rotate(' + (6 * date.getSeconds()) + ')'}, 
	                                                  React.createElement("line", {className: "second", y1: "10", y2: "-38"}), 
	                                                  React.createElement("line", {className: "second-counterweight", y1: "10", y2: "2"})
	                                              )
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DigitalClock = React.createClass({displayName: "DigitalClock",
	    propTypes: {
	        date: React.PropTypes.instanceOf(Date)
	    },
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var isIterateeCall = __webpack_require__(31);
